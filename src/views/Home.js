        ...
        <section id="Home" className="section---light demo-4---home-hero wf-section">
            ...
            <div className='section---light demo-4---home-hero home-section'>
                <div className="container header-text">
                    ...
                    <p className="paragraph-4">Arabian Camels is the first NFT community to create a Hollywood movie together. Linking movies and gaming with NFTs and DeFi. The first movie in history funded by an NFT - Owned by everyone.</p>
